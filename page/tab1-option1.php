...
/** @var Core $this */
?>
    <h3><?php esc_html_e('General add-on settings', 'buy-one-click-woocommerce'); ?> <?php echo Core::NAME_PLUGIN; ?></h3>
...
?>
    <form method="post" action="options.php">
        ...
        <fieldset>
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[plugin_work_mode]" type="radio" value="0" <?php checked($booc_commonOptions->getPluginWorkMode(), 0); ?>><?php esc_html_e('Basic operation', 'buy-one-click-woocommerce'); ?></p>
                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[plugin_work_mode]" type="radio" value="1" <?php checked($booc_commonOptions->getPluginWorkMode(), 1); ?>><?php esc_html_e('Add to cart mode', 'buy-one-click-woocommerce'); ?></p>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="<?php echo Core::OPTIONS_GENERAL; ?>[namebutton]" value="<?php echo esc_attr($booc_commonOptions->getNameButton()); ?>" />
                ...
                <tr valign="top">
                    ...
                    <td>
                        <select name="<?php echo Core::OPTIONS_GENERAL; ?>[positionbutton_out_stock]">
                            ...
                            ?>><?php _e('woocommerce_get_stock_html', 'buy-one-click-woocommerce'); ?></option>

                        </select>
                        <span class="description"><?php _e('The place where the button will be located in the item card if the item is not in stock. Only for the main button position in woocommerce_after_add_to_cart_button', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Write orders to the Woocommerce table', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>/>
                        <span class="description"><?php _e('Setting the checkbox will enable the mechanism when the orders will get not only to the table of the plug-in, but also to the menu "Orders" - Woocommerce', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Enable button display in categories', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>/>
                        <span class="description"><?php _e('The option enables or disables the display of the order button in one click in product categories. You can select a display position further.', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Position of the button in the category', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        <select name="buyoptions[positionbutton_category]">
                            ...
                            ?>><?php _e('Over the goods', 'buy-one-click-woocommerce'); ?></option>
                            ...
                            ?>><?php _e('Under the name of the product to the price', 'buy-one-click-woocommerce'); ?></option>
                            ...
                            ?>><?php _e('Under the goods', 'buy-one-click-woocommerce'); ?></option>

                        </select>
                        <span class="description"><?php _e('The place where the button will be located in the category of goods', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('WooCommerce Order Status', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        <span class="description"><?php _e('The created order will be transferred to this status after registration via the quick order form. It only works when integrated with WooCommerce.', 'buy-one-click-woocommerce'); ?></span>
        ...
        <fieldset>
            <legend><?php _e('Information on the order form', 'buy-one-click-woocommerce'); ?></legend>
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('Show product information?', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>/>
                        <span class="description"><?php _e('Will the product information be displayed in a modal window or not? The tick is worth it - will be displayed', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row"><?php _e('Ask for full name', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        <input type="checkbox" name="<?php echo Core::OPTIONS_GENERAL; ?>[fio_chek]" <?php
                            checked($booc_commonOptions->isEnableFieldWithName());
                        ?>/>
                        <span class="description"><?php _e('Does the buyer have to enter his name? A check mark is to offer', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Ask phone', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        <input type="checkbox" name="<?php echo Core::OPTIONS_GENERAL; ?>[fon_chek]" <?php
                            checked($booc_commonOptions->isEnableFieldWithPhone());
                        ?>/>
                        <span class="description"><?php _e('Does the buyer have to enter his phone? Tick is worth - offer', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Ask for Email', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        <input type="checkbox" name="<?php echo Core::OPTIONS_GENERAL; ?>[email_chek]" <?php
                            checked($booc_commonOptions->isEnableFieldWithEmail());
                        ?>/>
                        <span class="description"><?php _e('Does the buyer have to enter their email? Tick is worth - offer', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Additional Information Field', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        <input type="checkbox" name="<?php echo Core::OPTIONS_GENERAL; ?>[dopik_chek]" <?php
                            checked($booc_commonOptions->isEnableFieldWithComment());
                        ?>/>
                        <span class="description"><?php _e('Does the buyer have to enter additional information? Tick is worth - offer', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Quantity', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>/>
                        <span class="description"><?php _e('Add a quantity input form', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('File upload field', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>/>
                        <span class="description"><?php _e('Add the ability to attach a file to the quick order form. Tick is worth - offer', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
            </table>
        </fieldset>
        <fieldset>
            <legend><?php _e('Description of form fields', 'buy-one-click-woocommerce'); ?></legend>
            <table class="form-table">

                <tr valign="top">
                    <th scope="row"><?php _e('Name field', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For example, "Your name?"', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                    <th scope="row"><?php _e('Obligatory field?', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Telephone box', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For example, "Your phone?"', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                    <th scope="row"><?php _e('Obligatory field?', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                    ...
                    <th scope="row"><?php _e('Format hint', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('for example', 'buy-one-click-woocommerce'); ?> "+7 XXX XXX XX XX"</span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Phone number entry format', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For input formatting used JS plugin jquery.maskedinput. Examples:', 'buy-one-click-woocommerce'); ?> 99-9999999, 999-99-9999,(999) 999-9999, +7(999)-999-99-99 ...</span>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Email field', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For example, "Your email?"', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                    <th scope="row"><?php _e('Obligatory field?', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Field "Advanced"', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For example, "Delivery Address"', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                    <th scope="row"><?php _e('Obligatory field?', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Field "Upload file"', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For example, "Upload file"', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                    <th scope="row"><?php _e('Obligatory field?', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Name of the button in the form', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For example, "Order"', 'buy-one-click-woocommerce'); ?></span>
                    </td>
        ...
        <fieldset>
            <legend><?php _e('Behavior and dependencies on some WooCommerce options', 'buy-one-click-woocommerce'); ?></legend>
            <table class="form-table">
                <tr valign="top">
                    <td><?php _e('Actions related to setting "Balance Status" in WooCommerce', 'buy-one-click-woocommerce'); ?></td>
                    <td>
                        <?php _e('Enable this option?', 'buy-one-click-woocommerce'); ?>
                    ...
                    <th scope="row"><?php _e('Text on the button if the product is not in stock', 'buy-one-click-woocommerce'); ?></th>
                    <td>
                        ...
                        ?>" />
                        <span class="description"><?php _e('For example, "Make a pre-order"', 'buy-one-click-woocommerce'); ?></span>
                    </td>
                </tr>
            </table>
        </fieldset>
        <fieldset>
            <legend><?php _e('Actions and notifications', 'buy-one-click-woocommerce'); ?></legend>
            <table class="form-table">
                <tr valign="top">
                ...
                <tr valign="top">
                    <th scope="row"><?php esc_html_e('What to do after pressing the button', 'buy-one-click-woocommerce'); ?> <?php
                        ...
                        ?></th>
                    <td>
                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action]" type="radio" value="1" <?php checked($booc_commonOptions->getActionAfterSubmittingForm(), 1); ?>> <?php _e('Nothing to do', 'buy-one-click-woocommerce'); ?></p><span class="description"><?php _e('The window will remain open, the user will see the message above.', 'buy-one-click-woocommerce'); ?></span>
                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action]" type="radio" value="2" <?php checked($booc_commonOptions->getActionAfterSubmittingForm(), 2); ?>> <?php _e('Close through', 'buy-one-click-woocommerce'); ?> <input type="text" name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action_close]" maxlength="6" pattern="[0-9]*" size="5"  value="<?php
                            echo esc_attr($booc_commonOptions->getSecondsBeforeClosingForm());
                            ?>" /><?php _e('ms', 'buy-one-click-woocommerce'); ?>.</p><span class="description"><?php _e('For example: "2000". The user will see the message above and the form will be closed after the specified time.', 'buy-one-click-woocommerce'); ?></span>
                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action]" type="radio" value="3" <?php checked($booc_commonOptions->getActionAfterSubmittingForm(), 3); ?>> <?php _e('Show message (html available)', 'buy-one-click-woocommerce'); ?></p>  <textarea cols="20" rows="4" name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action_message]"><?php
                            echo esc_attr($booc_commonOptions->getMessageAfterSubmittingForm());
                            ?></textarea>
                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action]" type="radio" value="4" <?php checked($booc_commonOptions->getActionAfterSubmittingForm(), 4); ?>> <?php _e('Redirect to page', 'buy-one-click-woocommerce'); ?> <input type="text" name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action_redirect]" value="<?php
                            echo esc_attr($booc_commonOptions->getUrlRedirectAddress());
                            ?>" />

                        </p><span class="description"><?php esc_html_e('Example', 'buy-one-click-woocommerce'); ?>: <a href="https://coderun.ru">"https://coderun.ru"</a>. <?php _e('The user will see the message and go to the specified page.', 'buy-one-click-woocommerce'); ?></span>

                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action]" type="radio" value="5" <?php checked($booc_commonOptions->getActionAfterSubmittingForm(), 5); ?>>
                            <?php _e('Send to the order page WooCommerce', 'buy-one-click-woocommerce'); ?></p>
                        ...
                        <p><input name="<?php echo Core::OPTIONS_GENERAL; ?>[success_action]" type="radio" value="6" <?php checked($booc_commonOptions->getActionAfterSubmittingForm(), 6); ?>>
        ...
        <fieldset>
            ...
            <p>№1. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[form_style_color]" type="radio" value="1" <?php checked($booc_commonOptions->getFormStyle(), 1); ?>> <?php _e('Basic', 'buy-one-click-woocommerce'); ?></p>
            <p>№2. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[form_style_color]" type="radio" value="2" <?php checked($booc_commonOptions->getFormStyle(), 2); ?>> <?php _e('Blue', 'buy-one-click-woocommerce'); ?></p>
            <p>№3. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[form_style_color]" type="radio" value="3" <?php checked($booc_commonOptions->getFormStyle(), 3); ?>> <?php _e('Red', 'buy-one-click-woocommerce'); ?></p>
            <p>№4. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[form_style_color]" type="radio" value="4" <?php checked($booc_commonOptions->getFormStyle(), 4); ?>> <?php _e('Green', 'buy-one-click-woocommerce'); ?></p>
            <p>№5. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[form_style_color]" type="radio" value="5" <?php checked($booc_commonOptions->getFormStyle(), 5); ?>> <?php _e('Orange', 'buy-one-click-woocommerce'); ?></p>
            <p>№6. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[form_style_color]" type="radio" value="6" <?php checked($booc_commonOptions->getFormStyle(), 6); ?>> <?php _e('Your WordPress Theme Styles', 'buy-one-click-woocommerce'); ?></p>
        ...
        <fieldset>
            ...
            <p><?php esc_html_e('Do not send the order form more often than: (seconds)', 'buy-one-click-woocommerce'); ?>. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[time_limit_send_form]" type="number" value="<?php echo esc_attr($booc_commonOptions->getFormSubmissionLimit()); ?>"></p>
            <p><?php esc_html_e('Message in the form when re-sending.', 'buy-one-click-woocommerce'); ?>. <input name="<?php echo Core::OPTIONS_GENERAL; ?>[time_limit_message]" type="txt" value="<?php echo esc_attr($booc_commonOptions->getFormSubmissionLimitMessage()); ?>"></p>
            ...
            <p><?php esc_html_e('Consent to the processing of personal data', 'buy-one-click-woocommerce'); ?>: <?php _e('Enable?', 'buy-one-click-woocommerce') ?>
                ...
                ?>> <?php esc_html_e('Text (can HTML)', 'buy-one-click-woocommerce') ?> <input name="<?php echo Core::OPTIONS_GENERAL; ?>[conset_personal_data_text]" size="80" type="txt" value="<?php echo esc_attr($booc_commonOptions->getDescriptionConsentToProcessing()); ?>">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <p>
                            <?php _e('Do not use in the order form', 'buy-one-click-woocommerce'); ?>
                            <input
